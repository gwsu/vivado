...
connect_bd_intf_net -intf_net [get_bd_intf_nets jtag_axi_0_M_AXI] [get_bd_intf_pins jtag_axi_0/M_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_net -net clk_wiz_clk_out1 [get_bd_pins aurora_64b66b_0/drp_clk_in] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_chip2chip_0/s_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/M01_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins clk_wiz/clk_out1] [get_bd_pins jtag_axi_0/aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins vio_0/clk]
  ...
  connect_bd_net -net rst_clk_wiz_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_chip2chip_0/s_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/M01_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins jtag_axi_0/aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
...
preplace netloc aurora_64b66b_0_init_clk_out 1 3 4 960 170 NJ 170 NJ 170 2220
preplace netloc clk_wiz_locked 1 1 2 50 -750 470
preplace netloc aurora_64b66b_0_user_clk_out 1 3 4 960 -260 NJ -260 NJ -260 2250
preplace netloc axi_mem_intercon_M03_AXI 1 1 5 80J -520 NJ -520 920 -520 NJ -520 1750
...
preplace netloc axi_mem_intercon_M00_AXI 1 2 4 490 -940 NJ -940 NJ -940 1750
preplace netloc jtag_axi_0_M_AXI 1 1 5 80J -930 NJ -930 NJ -930 1390 -930 1760
preplace netloc diff_clock_rtl_1 1 0 2 NJ -430 N
preplace netloc proc_sys_reset_0_interconnect_aresetn 1 3 2 NJ -770 1390J
preplace netloc aurora_64b66b_0_channel_up 1 3 4 890 200 NJ 200 NJ 200 2240
preplace netloc GT_SERIAL_RX_1 1 0 6 NJ -60 NJ -60 NJ -60 900J -130 NJ -130 1740
preplace netloc axi_chip2chip_0_AXIS_TX 1 4 3 N -50 1750J -250 2230J
preplace netloc xlconstant_0_dout 1 1 1 40
preplace netloc INIT_DIFF_CLK_1 1 0 6 NJ -40 NJ -40 NJ -40 930J -120 NJ -120 1760
preplace netloc ext_reset_in_1 1 0 3 -230J -810 NJ -810 N
preplace netloc axi_chip2chip_0_axi_c2c_config_error_out 1 1 4 70J 180 NJ 180 NJ 180 1410
preplace netloc axi_chip2chip_0_aurora_pma_init_out 1 4 2 N 10 1750J
preplace netloc GT_DIFF_REFCLK1_1 1 0 6 -230J -70 NJ -70 NJ -70 870J -140 1430J -110 N
preplace netloc pma_init_in_1 1 0 4 -230J 80 NJ 80 NJ 80 N
preplace netloc axi_chip2chip_0_axi_c2c_multi_bit_error_out 1 1 4 60J -30 NJ -30 940J -110 1390
preplace netloc aurora_64b66b_0_GT_SERIAL_TX 1 6 2 NJ -120 NJ
preplace netloc aurora_64b66b_0_mmcm_not_locked_out 1 3 4 950 210 NJ 210 NJ 210 2230
preplace netloc aurora_64b66b_0_USER_DATA_M_AXIS_RX 1 3 4 950 -270 NJ -270 NJ -270 2260
preplace netloc axi_chip2chip_0_axi_c2c_link_error_out 1 1 4 80J -50 NJ -50 880J -160 1420
preplace netloc axi_chip2chip_0_aurora_reset_pb 1 4 2 N 30 1780J
preplace netloc rst_clk_wiz_100M_peripheral_aresetn 1 2 3 500 -410 910J -750 1430
preplace netloc clk_wiz_clk_out1 1 1 5 60 -660 480 -430 890J -430 1420 -430 1770
levelinfo -pg 1 -250 -30 340 700 1190 1600 2030 2400 2540 -top -1320 -bot 770
",
}
