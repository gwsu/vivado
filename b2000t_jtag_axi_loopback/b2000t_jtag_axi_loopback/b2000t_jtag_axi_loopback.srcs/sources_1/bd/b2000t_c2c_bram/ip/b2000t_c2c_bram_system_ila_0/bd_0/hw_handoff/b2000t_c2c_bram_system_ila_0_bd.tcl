...
################################################################
# This is a generated script based on design: bd_6d24
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set SLOT_0_AXI_araddr [ create_bd_port -dir I -from 31 -to 0 SLOT_0_AXI_araddr ]
  set SLOT_0_AXI_arburst [ create_bd_port -dir I -from 1 -to 0 SLOT_0_AXI_arburst ]
  set SLOT_0_AXI_arid [ create_bd_port -dir I -from 0 -to 0 SLOT_0_AXI_arid ]
  set SLOT_0_AXI_arlen [ create_bd_port -dir I -from 7 -to 0 SLOT_0_AXI_arlen ]
  set SLOT_0_AXI_arready [ create_bd_port -dir I SLOT_0_AXI_arready ]
  set SLOT_0_AXI_arsize [ create_bd_port -dir I -from 2 -to 0 SLOT_0_AXI_arsize ]
  set SLOT_0_AXI_arvalid [ create_bd_port -dir I SLOT_0_AXI_arvalid ]
  set SLOT_0_AXI_awaddr [ create_bd_port -dir I -from 31 -to 0 SLOT_0_AXI_awaddr ]
  set SLOT_0_AXI_awburst [ create_bd_port -dir I -from 1 -to 0 SLOT_0_AXI_awburst ]
  set SLOT_0_AXI_awid [ create_bd_port -dir I -from 0 -to 0 SLOT_0_AXI_awid ]
  set SLOT_0_AXI_awlen [ create_bd_port -dir I -from 7 -to 0 SLOT_0_AXI_awlen ]
  set SLOT_0_AXI_awready [ create_bd_port -dir I SLOT_0_AXI_awready ]
  set SLOT_0_AXI_awsize [ create_bd_port -dir I -from 2 -to 0 SLOT_0_AXI_awsize ]
  set SLOT_0_AXI_awvalid [ create_bd_port -dir I SLOT_0_AXI_awvalid ]
  set SLOT_0_AXI_bid [ create_bd_port -dir I -from 0 -to 0 SLOT_0_AXI_bid ]
  ...
  set SLOT_0_AXI_rid [ create_bd_port -dir I -from 0 -to 0 SLOT_0_AXI_rid ]
  set SLOT_0_AXI_rlast [ create_bd_port -dir I SLOT_0_AXI_rlast ]
  ...
  set SLOT_0_AXI_wlast [ create_bd_port -dir I SLOT_0_AXI_wlast ]
...
connect_bd_intf_net -intf_net Conn [get_bd_intf_ports SLOT_0_AXI] [get_bd_intf_pins g_inst/slot_0_axi]
  ...
  connect_bd_net -net net_slot_0_axi_awburst [get_bd_pins g_inst/m_slot_0_axi_awburst] [get_bd_pins ila_lib/probe8]
  connect_bd_net -net net_slot_0_axi_awid [get_bd_pins g_inst/m_slot_0_axi_awid] [get_bd_pins ila_lib/probe9]
  ...
  connect_bd_net -net net_slot_0_axi_bid [get_bd_pins g_inst/m_slot_0_axi_bid] [get_bd_pins ila_lib/probe12]
  ...
  connect_bd_net -net net_slot_0_axi_rid [get_bd_pins g_inst/m_slot_0_axi_rid] [get_bd_pins ila_lib/probe15]
