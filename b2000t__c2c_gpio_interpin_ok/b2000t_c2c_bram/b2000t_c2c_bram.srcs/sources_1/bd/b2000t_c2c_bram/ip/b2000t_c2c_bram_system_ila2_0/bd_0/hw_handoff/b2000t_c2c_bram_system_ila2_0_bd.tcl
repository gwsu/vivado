...
################################################################
# This is a generated script based on design: bd_22d1
#
...
proc create_root_design { parentCell } {
  ...
  set probe1 [ create_bd_port -dir I -from 25 -to 0 probe1 ]
  set probe2 [ create_bd_port -dir I -from 25 -to 0 probe2 ]
  ...
  set probe6 [ create_bd_port -dir I -from 25 -to 0 probe6 ]
  set probe7 [ create_bd_port -dir I -from 25 -to 0 probe7 ]
