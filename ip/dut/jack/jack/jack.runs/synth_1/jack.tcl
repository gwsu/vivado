...
read_verilog -library xil_defaultlib /home/wesleyguo/github/vivado/vivado/ip/dut/jack/jack/jack.srcs/sources_1/imports/sources_1/jack.v
foreach dcp [get_files -quiet -all *.dcp] {
  set_property used_in_implementation false $dcp
}

synth_design -top jack -part xc7v2000tflg1925-1


write_checkpoint -force -noxdef jack.dcp

catch { report_utilization -file jack_utilization_synth.rpt -pb jack_utilization_synth.pb }
