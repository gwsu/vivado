...
(* CORE_GENERATION_INFO = "bd_3457,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_3457,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=12,numReposBlks=12,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "jtag_axi_system_ila_0_0.hwdef" *) 
module bd_3457
   (SLOT_0_AXI_araddr,
    SLOT_0_AXI_arburst,
    SLOT_0_AXI_arcache,
  ...
  bd_3457_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe38(net_slot_1_axi_arsize),
        .probe39(net_slot_1_axi_awaddr),
        .probe4(net_slot_0_axi_arlen),
        .probe40(net_slot_1_axi_awburst),
        .probe41(net_slot_1_axi_awcache),
        .probe42(net_slot_1_axi_awid),
        .probe43(net_slot_1_axi_awlen),
        .probe44(net_slot_1_axi_awlock),
        .probe45(net_slot_1_axi_awprot),
        .probe46(net_slot_1_axi_awqos),
