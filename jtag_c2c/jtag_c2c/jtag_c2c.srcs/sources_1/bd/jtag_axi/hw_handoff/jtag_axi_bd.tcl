...
CONFIG.FREQ_HZ {100000000} \
  ...
  set pma_init_in [ create_bd_port -dir I pma_init_in ]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets jtag_axi_0_M_AXI] [get_bd_intf_pins jtag_axi_0/M_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins clk_wiz/reset] [get_bd_pins system_ila_0/probe0] [get_bd_pins vio_0/probe_out0]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets vio_0_probe_out0]
  connect_bd_net -net vio_0_probe_out1 [get_bd_ports pma_init_in] [get_bd_pins axi_chip2chip_0/aurora_pma_init_in] [get_bd_pins system_ila_0/probe1]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets vio_0_probe_out1]
  connect_bd_net -net vio_0_probe_out2 [get_bd_pins rst_clk_wiz_100M/ext_reset_in] [get_bd_pins vio_0/probe_out1]
...
#  -string -flagsOSRD
preplace port pma_init_in -pg 1 -y 40 -defaultsOSRD
...
preplace inst system_ila_0 -pg 1 -lvl 1 -y -580 -defaultsOSRD
...
preplace netloc axi_mem_intercon_M01_AXI 1 4 2 NJ -800 2080
preplace netloc aurora_64b66b_0_init_clk_out 1 2 4 890 210 NJ 210 NJ 210 2110
preplace netloc clk_wiz_locked 1 0 6 -70 -670 370 -600 NJ -600 NJ -600 NJ -600 2120J
preplace netloc aurora_64b66b_0_user_clk_out 1 2 4 810 180 NJ 180 NJ 180 2080
preplace netloc axi_mem_intercon_M03_AXI 1 2 3 890 -610 NJ -610 1660
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 0 3 -50 -490 NJ -490 810J
preplace netloc axi_bram_ctrl_0_BRAM_PORTB 1 0 3 -40 -480 NJ -480 800J
preplace netloc axi_chip2chip_0_axi_c2c_link_status_out 1 0 4 -60 -50 NJ -50 850J -150 1330
preplace netloc axi_mem_intercon_M00_AXI 1 1 4 400 -580 NJ -580 NJ -580 1690
preplace netloc jtag_axi_0_M_AXI 1 0 5 -40 -910 NJ -910 NJ -910 1340 -590 1660
preplace netloc diff_clock_rtl_1 1 0 1 N
preplace netloc axi_mem_intercon_M02_AXI 1 4 2 NJ -780 2090
preplace netloc aurora_64b66b_0_channel_up 1 2 4 870 200 NJ 200 NJ 200 2120
preplace netloc axi_perf_mon_0_interrupt 1 6 1 N
preplace netloc vio_0_probe_out0 1 0 2 -60 -500 360
preplace netloc GT_SERIAL_RX_1 1 0 5 NJ -60 NJ -60 860J -120 NJ -120 1680
preplace netloc axi_chip2chip_0_AXIS_TX 1 3 2 N -50 1670J
preplace netloc vio_0_probe_out1 1 0 3 -90 80 NJ 80 N
preplace netloc rst_clk_wiz_100M_interconnect_aresetn 1 2 2 NJ -690 1330
preplace netloc INIT_DIFF_CLK_1 1 0 5 NJ -40 NJ -40 880J -110 1360J -90 N
preplace netloc vio_0_probe_out2 1 1 1 380
preplace netloc axi_chip2chip_0_axi_c2c_config_error_out 1 0 4 -40 -30 NJ -30 840J -180 1340
preplace netloc axi_chip2chip_0_aurora_pma_init_out 1 3 2 N 10 1670J
preplace netloc GT_DIFF_REFCLK1_1 1 0 5 -100J -70 390J -130 NJ -130 NJ -130 1660
preplace netloc axi_chip2chip_0_axi_c2c_multi_bit_error_out 1 0 4 -70 190 NJ 190 NJ 190 1330
preplace netloc aurora_64b66b_0_GT_SERIAL_TX 1 5 2 NJ -120 NJ
preplace netloc aurora_64b66b_0_mmcm_not_locked_out 1 2 4 900 170 NJ 170 NJ 170 2090
preplace netloc axi_hwicap_0_ip2intc_irpt 1 6 1 2360
preplace netloc aurora_64b66b_0_USER_DATA_M_AXIS_RX 1 2 4 900 -260 NJ -260 NJ -260 2090
preplace netloc axi_chip2chip_0_axi_c2c_link_error_out 1 0 4 -50 -20 NJ -20 830J -160 1350
preplace netloc axi_chip2chip_0_aurora_reset_pb 1 3 2 N 30 1700J
preplace netloc rst_clk_wiz_100M_peripheral_aresetn 1 1 5 410 -450 820J -450 1360 -450 NJ -450 2100
preplace netloc clk_wiz_clk_out1 1 0 6 -80 -690 390 -430 870J -430 1350 -430 1690 -430 2110
levelinfo -pg 1 -140 230 630 1130 1520 1890 2240 2380 -top -1280 -bot 770
",
}
